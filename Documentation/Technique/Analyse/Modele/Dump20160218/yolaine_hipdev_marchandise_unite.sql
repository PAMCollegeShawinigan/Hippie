...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Table permettant de mettre un type de mesure sur la marchandise.';
...
INSERT INTO `marchandise_unite` (`unite_id`, `description_marchandise_unite`) VALUES (1,'Lbs'),(2,'Kg'),(3,'Unité(s)'),(4,'ml'),(5,'L'),(6,'Oz'),(7,'gr');
