...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table permettant d''identifier les types d''aliment offert.';
...
INSERT INTO `type_aliment` (`aliment_id`, `description_type_aliment`) VALUES (1,'Fruits et Légumes'),(2,'Produits laitiers'),(3,'Viandes'),(4,'Surgelés'),(5,'Non Périssable'),(6,'Boulangerie');
