...
public class TestDonneeCentre {
    public static ArrayList<Organisme> prepareDonnees_reservees() {
        ...
        listDenree1.add(new Denree("orange", "2", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree1.add(new Denree("poulet", "3", "unite", "9999-12-31", Denree.TypeDenree.perissable));
        ...
        listDenree3.add(new Denree("carrot", "41", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        ...
        listDenree4.add(new Denree("tuna", "90", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        ...
        listDenree6.add(new Denree("tuna", "34", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        listDenree6.add(new Denree("beuf", "19", "kg", "9999-12-31", Denree.TypeDenree.viande));
    ...
    public static ArrayList<Organisme> prepareDonnees_disponible() {
        ...
        listDenree1.add(new Denree("orange", "2", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree1.add(new Denree("poulet", "3", "unite", "9999-12-31", Denree.TypeDenree.perissable));
        listDenree1.add(new Denree("prune", "13", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree1.add(new Denree("lait", "6", "litre", "9999-12-31", Denree.TypeDenree.laitier));
        HashMap<String, String> mapCollectTime1 = new HashMap<>();
        mapCollectTime1.put("lundi", "12:00-14:00");
        mapCollectTime1.put("mardi", "9:00-16:00");
        mapCollectTime1.put("mercredi", "8:00-13:00");
        ...
        listDenree2.add(new Denree("pomme", "33", "kg", "9999-12-31", Denree.TypeDenree.boulangerie));
        listDenree2.add(new Denree("avocat", "8", "unite", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree2.add(new Denree("rasin", "7", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree2.add(new Denree("patate", "21", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        ...
        ArrayList<Denree> listDenree3 = new ArrayList<>();
        listDenree3.add(new Denree("croissant", "7", "unite", "9999-12-31", Denree.TypeDenree.boulangerie));
        listDenree3.add(new Denree("mais", "40", "kg", "9999-12-31", Denree.TypeDenree.perissable));
        listDenree3.add(new Denree("carrot", "41", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        HashMap<String, String> mapCollectTime3 = new HashMap<>();
        mapCollectTime3.put("lundi", "9:00-14:00");
        mapCollectTime3.put("mardi", "9:00-11:00");
        ...
        ArrayList<Denree> listDenree4 = new ArrayList<>();
        listDenree4.add(new Denree("rasin", "37", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree4.add(new Denree("tuna", "90", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        HashMap<String, String> mapCollectTime4 = new HashMap<>();
        mapCollectTime4.put("lundi", "9:00-12:00");
        mapCollectTime4.put("mardi", "9:00-14:00");
        ...
        listDenree5.add(new Denree("tuna", "34", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        listDenree5.add(new Denree("avocat", "27", "unite", "9999-12-31", Denree.TypeDenree.perissable));
        listDenree5.add(new Denree("orange", "56", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree5.add(new Denree("samon", "34", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        listDenree5.add(new Denree("beuf", "9", "kg", "9999-12-31", Denree.TypeDenree.viande));
        ...
        ArrayList<Denree> listDenree6 = new ArrayList<>();
        listDenree6.add(new Denree("tuna", "34", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        listDenree6.add(new Denree("avocat", "27", "kg", "9999-12-31", Denree.TypeDenree.perissable));
        listDenree6.add(new Denree("orange", "23", "kg", "9999-12-31", Denree.TypeDenree.fruit_legume));
        listDenree6.add(new Denree("samon", "4", "kg", "9999-12-31", Denree.TypeDenree.surgele));
        listDenree6.add(new Denree("beuf", "19", "kg", "9999-12-31", Denree.TypeDenree.viande));
        HashMap<String, String> mapCollectTime6 = new HashMap<>();
        mapCollectTime6.put("lundi", "9:00-10:00");
        mapCollectTime6.put("mardi", "11:00-14:00");
