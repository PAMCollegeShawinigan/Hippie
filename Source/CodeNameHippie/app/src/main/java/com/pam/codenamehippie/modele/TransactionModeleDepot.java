 ...
 */
public class TransactionModeleDepot extends BaseModeleDepot {


    private SimpleArrayMap<Integer, TransactionModele> modeles = null;
     ...
     *
     * @param id de l'objet TransactionModele
